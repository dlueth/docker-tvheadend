...
RUN \
 ...
 cd /tmp/tvheadend && \
 git fetch origin ${TVHEADEND_BRANCH}:branch && \
 git checkout branch && \
 ./configure \
	`#Encoding` \
...
RUN \
 ...
 echo "**** Cleanup ****" && \
 rm -rf /var/cache/apk/* /tmp/* /var/tmp/* /var/log/* /usr/share/doc/ /usr/share/man/ /usr/share/locale/ /root/.cpan /root/.cpanm
